        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
            <BContainer fluid class="custom-container">
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <Link href="/auth/signin-basic" class="btn btn-soft-danger"><i
                ...
                <BRow class="align-items-center justify-content-lg-between justify-content-center gy-4">
                    ...
                    <BCol lg="6">
                        <div class="text-muted">
                            <h1 class="mb-3 fw-bold">Find Your <span class="text-primary">Dream Job</span> in One Place
                            </h1>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    <BCol sm>
                        <div>
                            <h4 class="text-white fw-bold">Ready to Started?</h4>
