            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#hero"
                                @click.prevent="scrollToSection('hero')">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#services"
                                @click.prevent="scrollToSection('services')">Services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#features"
                                @click.prevent="scrollToSection('features')">Features</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#plans"
                                @click.prevent="scrollToSection('plans')">Plans</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#reviews"
                                @click.prevent="scrollToSection('reviews')">Reviews</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#team"
                                @click.prevent="scrollToSection('team')">Team</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15 fw-semibold" to="#contact"
                                @click.prevent="scrollToSection('contact')">Contact</a>
                        </li>
                    </ul>

                    <div class="">
                        <Link href="/auth/signin-basic" class="btn btn-link fw-medium text-decoration-none text-dark">Sign
                        in</Link>
                    ...
                    <BCol lg="4">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div>
                                    <BLink to="#" class="fs-13 fw-semibold">Learn More <i
