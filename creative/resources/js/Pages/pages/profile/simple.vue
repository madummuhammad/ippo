                        ...
                        <BCol cols="6" md="4">
                          <div class="d-flex mt-4">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                              ...
                              <BLink href="#" class="fw-semibold fs-15">www.velzon.com</BLink>
                            </div>
                          </div>
                        </BCol>
                      </BRow>
                              ...
                              <BCard no-body class="profile-project-card shadow-none profile-project-success mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <BBadge variant="warning-subtle" class="bg-warning-subtle text-warning fs-12">
                                        Inprogress
                                      </BBadge>
                                    </div>
                                  </div>
                              ...
                              <BCard no-body class="profile-project-card shadow-none profile-project-danger mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-12">
                                        Completed
                                      </BBadge>
                                    </div>
                                  </div>
                      ...
                      <BCard no-body class="profile-project-card shadow-none profile-project-success">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary fs-12">
                                Progress
                              </BBadge>
                            </div>
                          </div>
                      ...
                      <BCard no-body class="profile-project-card shadow-none profile-project-info">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <BBadge variant="info-subtle" class="bg-info-subtle text-info fs-12">New</BBadge>
                            </div>
                          </div>
