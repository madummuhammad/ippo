                        ...
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-12">Business
                                </BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary fs-12">Product</BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-12">Business</BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="danger-subtle" class="bg-danger-subtle text-danger fs-12">Design</BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="warning-subtle" class="bg-warning-subtle text-warning fs-12">Development</BBadge>
                              </li>
                            </ul>
                            <h5>
