  ...
  <Layout>
    ...
    <BRow>
      <BCol xl="4">
        <BCard no-body>
          <BCardBody class="p-0">
            <BAlert :model-value="true" variant="warning" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
      ...
      <BCol xl="4">
        <BCard no-body class="bg-primary">
          <BCardBody class="p-0">
            <BAlert :model-value="true" variant="danger" class="rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" show>
          ...
          <BCardBody>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                ...
                <h5 class="fs-15 mb-0 fw-bold">Half Sleeve T-Shirts (Blue)</h5>
              </div>
            </div>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                <p class="text-muted mb-2">Adidas</p>
                <h5 class="fs-15 mb-0 fw-bold">Half Sleeve T-Shirts (Pink)</h5>
              </div>
            </div>
            <p class="text-muted pb-1">If you couldn't relate to the information in the previous point, you might be
              looking for the singlet T-shirt, which is also known as the half T-shirt.</p>
          ...
          <BRow class="g-0">
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div>
                  <BButton type="button" variant="danger" class="rounded-pill w-sm"><i class="ri-add-fill me-1 align-bottom"></i> Follow</BButton>
                </div>
              </BCardBody>
            </BCol>
          </BRow>
