                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow30" hide-footer class="v-modal-custom" hide-header-close centered>
                                    <div class="modal-body text-center">
                                ...
                                <BModal v-model="modalShow31" hide-footer class="v-modal-custom" hide-header-close centered>
                                    <div class="modal-body text-center">
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            ...
                            <BModal v-model="modalShow4" hide-footer title="Tooltips and Popovers Modal"
                                title-class="fw-bold" class="v-modal-custom">
                                ...
                                <div class="modal-footer v-modal-footer">
                                    <div class="mx-auto">
                                        <BLink href="javascript:void(0);" class="btn btn-link fw-semibold">
                                            Read More
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow5" hide-footer title="Scrollable Modal" title-class="fw-bold"
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow6" hide-footer title="New message"
                                    title-class="varyingcontentModal fw-bold" class="v-modal-custom">
                                    <form>
                                        <div class="mb-3">
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow7" hide-footer title="Fullscreen Modal Heading"
                                    title-class="fw-bold" class="v-modal-custom" fullscreen>
                                    <h6 class="fs-16">Give your text a good structure</h6>
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-checkbox-circle-fill text-success"></i>
                                ...
                                <BModal v-model="modalShow8" hide-footer title="Extra large Modal" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow9" hide-footer title="Large Modal" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow10" hide-footer title="Small Modal" title-class="fw-bold"
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow16" hide-footer title="Full screen Modal" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow11" hide-footer title="Full screen below sm" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow12" hide-footer title="Full screen below md" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow13" hide-footer title="Full screen below lg" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow14" hide-footer title="Full screen below xl" title-class="fw-bold"
                                ...
                                <BModal v-model="modalShow15" hide-footer title="Full screen below xxl"
                                    title-class="fw-bold" dialog-class="modal-fullscreen-xxl-down" class="v-modal-custom">
                                    <h6 class="fs-16">Give your text a good structure</h6>
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-checkbox-circle-fill text-success"></i>
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow17" hide-footer title="Modal Heading" modal-class="fadeInRight"
                                    title-class="fw-bold" class="v-modal-custom" centered>
                                    <h5 class="fs-16">Overflowing text to show scroll behavior</h5>
                                    <p class="text-muted">One morning, when Gregor Samsa woke from troubled
                                        dreams, he found himself transformed in his bed into a horrible
                                        vermin. He lay on his armour-like back, and if he lifted his head a
            ...
            <BCol lg="12">
                ...
                <BRow>
                    ...
                    <BCol xl="4" md="6">
                        ...
                        <BModal v-model="modalShow27" hide-footer body-class="p-0" header-class="p-0" class="v-modal-custom"
                            content-class="border-0 overflow-hidden" centered hide-header-close>
                    ...
                    <BCol xl="4" md="6">
                        ...
                        <BModal v-model="modalShow28" body-class="p-0" header-class="p-0" hide-footer class="v-modal-custom"
                            content-class="border-0 overflow-hidden" size="lg" centered hide-header-close>
                            <BRow class="g-0">
                                <BCol lg="7">
                                    <div class="modal-body p-5">
                    ...
                    <BCol xl="4" md="6">
                        ...
                        <BModal v-model="modalShow29" hide-footer body-class="p-0" header-class="p-3" class="v-modal-custom fw-bold"
                            title="Sign Up" content-class="border-0 overflow-hidden" centered>
