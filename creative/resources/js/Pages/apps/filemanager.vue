...
<template>
  <Layout>
            ...
            <BRow class="justify-content-beetwen g-2 mb-3">
              ...
              <BCol cols="auto">
                <div class="d-flex gap-2 align-items-start mb-2">
                  ...
                  <BButton variant="primary" class="create-folder-modal text-nowrap flex-shrink-0" @click="openFolderModal"><i class="ri-add-line align-bottom me-1"></i> Create Folders
                  </BButton>
                </div>
              </BCol>
    ...
    <BModal v-model="folderModal" hide-footer title="Create Folder" title-class="exampleModalLabelFolder fw-bold" class="v-modal-custom" modal-class="zoomIn" centered header-class="p-3 bg-success-subtle">
      <BForm autocomplete="off" class="needs-validation createfolder-form" id="createfolder-form" novalidate>
        ...
        <div class="hstack gap-2 justify-content-end">
          <BButton type="button" variant="ghost-danger" data-bs-dismiss="modal" id="addFolderBtn-close" @click="folderModal = false">
    ...
    <BModal v-model="fileModal" hide-footer title="Create File" title-class="exampleModalLabel fw-bold" class="v-modal-custom" modal-class="zoomIn" centered header-class="p-3 bg-success-subtle">
