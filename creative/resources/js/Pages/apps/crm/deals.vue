            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-danger-subtle" role="button" v-b-toggle.leadDiscovered>
                        <h5 class="card-title text-uppercase fw-bold mb-1 bold">Lead Discovered</h5>
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-success-subtle" role="button" v-b-toggle.contactInitiated>
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-16">Contact Initiated</h5>
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-warning-subtle" role="button" v-b-toggle.needsIdentified>
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-16">Needs Identified</h5>
                ...
                <BCollapse id="needsIdentified" visible>
                    ...
                    <BCard no-body>
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified7">
                            <BCardBody>
                                <h6 class="fs-14 m5-1">Meta4Systems <BBadge tag="small" variant="success-subtle"
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-info-subtle" role="button" v-b-toggle.meetingArranged>
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-16">Meeting Arranged</h5>
