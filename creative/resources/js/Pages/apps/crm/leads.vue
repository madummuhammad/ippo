            ...
            <BOffcanvas v-model="rightOffcanvas" placement="end" title="Leads Filters" header-class="bg-light" body-class="p-0 overflow-hidden" footer-class="border-top p-3 text-center">
              <b-form action="" class="d-flex flex-column justify-content-end h-100">
                <div class="offcanvas-body">
                  <div class="mb-4">
                    <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold fs-13 mb-3">Date</label>
                  ...
                  <div class="mb-4">
                    <label for="country-select" class="form-label text-muted text-uppercase fw-semibold fs-13 mb-3">Country</label>
                  ...
                  <div class="mb-4">
                    <label for="status-select" class="form-label text-muted text-uppercase fw-semibold fs-13 mb-3">Status</label>
                    <BRow class="g-2">
                      <BCol lg="6">
                        <div class="form-check">
                  ...
                  <div class="mb-4">
                    <label for="leadscore" class="form-label text-muted text-uppercase fw-semibold fs-13 mb-3">Lead
                      Score</label>
                  ...
                  <div>
                    <label for="leads-tags" class="form-label text-muted text-uppercase fw-semibold fs-13 mb-3">Tags</label>
                    <BRow class="g-3">
                      <BCol lg="6">
                        <div class="form-check">
