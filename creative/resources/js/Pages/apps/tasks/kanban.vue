    ...
    <Layout>
        ...
        <div class="tasks-board mb-3" id="kanbanboard">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
                            <template #button-content><span class="fw-medium text-muted fs-14">Priority<i class="mdi mdi-chevron-down ms-1"></i></span></template>
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-bold mb-0">In Reviews
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-bold mb-0">new <BBadge tag="small" variant="success" class="align-bottom ms-1">1</BBadge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
