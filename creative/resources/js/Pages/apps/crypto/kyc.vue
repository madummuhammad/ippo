...
<template>
  <Layout>
    ...
    <BModal v-model="modalShow" body-class="p-0" header-class="p-3" title-class="fw-bold text-uppercase" hide-footer title="Verify your Account" class="v-modal-custom" size="lg" centered>
