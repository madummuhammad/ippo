      ...
      <BCol xxl="3" md="6">
        <BCard no-body class="card-animate">
          <BCardBody>
            ...
            <h3 class="mb-2">
              $ <count-to :duration="5000" :startVal="0" :endVal="74854"></count-to><small class="text-muted fs-14">.68k</small>
            </h3>
      ...
      <BCol xxl="3" md="6">
        <BCard no-body class="card-animate">
          <BCardBody>
            ...
            <h3 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="74361"></count-to><small class="text-muted fs-14">.34k</small>
            </h3>
      ...
      <BCol xxl="3" md="6">
        <BCard no-body class="card-animate">
          <BCardBody>
            ...
            <h3 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="97685"></count-to><small class="text-muted fs-14">.22k</small>
            </h3>
