...
export default {
    ...
    setup(props){
        var loginError=ref(props.loginError);
                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to IPPO.</p>
                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input :type="togglePassword ? 'text' : 'password'"
                                                    ...
                                                    id="password-input" v-model="form.password" autocomplete="password" :class="{ 'is-invalid': form.errors.password }">
